  ...
  const passwordchange = async () => {
    try {
      if (!currpw) {
        ...
        const response = await axios.get(
          `http://localhost/HealerZ/PHP/Inventory/settings/getPassword.php?employeeID=${userdata[0].employee_ID}`
        );
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title className="modaltitleee">Settings</Modal.Title>
        </Modal.Header>
        <Modal.Body>
